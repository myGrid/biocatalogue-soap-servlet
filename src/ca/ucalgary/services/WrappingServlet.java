...
import org.biocatalogue.soapservlet.jetty.BiocatalogueRecorder;
import org.w3c.dom.Node;
import org.w3c.dom.NodeList;

/**
 * WrappingServlet.java
 *
 * Abstract class for servlets that will act as proxies to existing Web-based resources
 * (e.g. Web Services and CGIs). Provides facilities for a DataRecorder to be
 * notified of transaction steps and inject code into requests and responses for
 * custom behaviours (e.g Daggoo's semantic markup fucntionality).
 *
...
public abstract class WrappingServlet extends HttpServlet{
	...
	public static final String DATARECORDER_CLASS = "BiocatalogueRecorder"; 
...
//			}
//		}
		setRecorder(new BiocatalogueRecorder());
...
//			}
//		}
//		if(DATARECORDER_CLASS!=null){
//			dataRecorderClassName=DATARECORDER_CLASS;
//		}
